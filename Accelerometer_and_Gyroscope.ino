...
void loop() {
  ...
  if(accelerometer_x>1000 && accelerometer_y<-8000){//Tilted towards -y axis
    digitalWrite(led_LB,HIGH);
    digitalWrite(led_RB,LOW);
    digitalWrite(led_RT,LOW);
    digitalWrite(led_LT,HIGH);
    }
   else if(accelerometer_x>0 && accelerometer_y>8000){//Tilted towards +y axis
    digitalWrite(led_LB,LOW);
    digitalWrite(led_RB,HIGH);
    digitalWrite(led_RT,HIGH);
    digitalWrite(led_LT,LOW);
    }
    else if(accelerometer_x>8000 && accelerometer_y<1000){//Tilted towards +x axis
  digitalWrite(led_LB,HIGH);
    digitalWrite(led_RB,HIGH);
    digitalWrite(led_RT,LOW);
    digitalWrite(led_LT,LOW);
